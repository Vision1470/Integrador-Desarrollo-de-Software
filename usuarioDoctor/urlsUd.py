...
urlpatterns = [
    ...
    path('cuidados-pacienteD/<int:paciente_id>/', views.cuidados_pacienteD, name='cuidados_pacienteD'),
    ...
    path('get-medicamento-info/<int:medicamento_id>/', views.get_medicamento_info, name='get_medicamento_info'),
      path('ver-receta-paciente/<int:paciente_id>/', views.ver_receta_paciente, name='ver_receta_paciente'),
]